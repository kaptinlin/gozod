...
func TestUnknownCoercion(t *testing.T) {
	t.Run("coerce flag", func(t *testing.T) {
		...
		schema := Unknown(SchemaParams{Coerce: true})
...
func TestUnknownTransformPipe(t *testing.T) {
	t.Run("transform values", func(t *testing.T) {
		schema := Unknown().Transform(func(val any, ctx *RefinementContext) (any, error) {
			if str, ok := val.(string); ok {
	...
	t.Run("transformAny values", func(t *testing.T) {
		schema := Unknown().TransformAny(func(val any, ctx *RefinementContext) (any, error) {
...
func TestUnknownRefine(t *testing.T) {
	...
	t.Run("refine vs transform distinction", func(t *testing.T) {
		...
		transformSchema := Unknown().Transform(func(val any, ctx *RefinementContext) (any, error) {
			if str, ok := val.(string); ok {
...
func TestUnknownErrorHandling(t *testing.T) {
	t.Run("custom error message", func(t *testing.T) {
		schema := Unknown(SchemaParams{Error: "Custom unknown message"})
...
func TestUnknownEdgeCases(t *testing.T) {
	t.Run("internals access", func(t *testing.T) {
		...
		assert.Equal(t, ZodTypeUnknown, internals.Type)
...
func TestUnknownDefaultAndPrefault(t *testing.T) {
	...
	t.Run("prefaultFunc", func(t *testing.T) {
		...
		result1, err1 := schema.Parse("valid") // String with length >= 4
		require.NoError(t, err1)
		...
		result2, err2 := schema.Parse("hi") // String with length < 4
		require.NoError(t, err2)
		...
		result3, err3 := schema.Parse("fail") // String with forbidden value
		require.NoError(t, err3)
	...
	t.Run("default vs prefault distinction", func(t *testing.T) {
		...
		prefaultSchema := Unknown().Prefault(prefaultValue).Refine(func(val any) bool {
		...
		result2, err2 := prefaultSchema.Parse("long_enough_string")
		require.NoError(t, err2)
		...
		result4, err4 := prefaultSchema.Parse(456)
		require.NoError(t, err4)
