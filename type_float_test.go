...
func TestFloatCoercion(t *testing.T) {
	t.Run("basic coercion", func(t *testing.T) {
		schema := Float64(SchemaParams{Coerce: true})
		tests := []struct {
			input    interface{}
			expected float64
		}{
	...
	t.Run("coercion with validation", func(t *testing.T) {
		schema := Float64(SchemaParams{Coerce: true}).Min(5.0).Max(100.0)
...
func TestFloatTransform(t *testing.T) {
	t.Run("basic transform", func(t *testing.T) {
		schema := Float64().Transform(func(val float64, ctx *RefinementContext) (any, error) {
			return val * 2.0, nil
		})
		result, err := schema.Parse(3.14)
		require.NoError(t, err)
	...
	t.Run("transform chaining", func(t *testing.T) {
		schema := Float64().
			Transform(func(val float64, ctx *RefinementContext) (any, error) {
				return val * 2.0, nil
			}).
	...
	t.Run("transform with validation", func(t *testing.T) {
		schema := Float64().Min(1.0).Transform(func(val float64, ctx *RefinementContext) (any, error) {
			if val < 0 {
	...
	t.Run("mathematical transforms", func(t *testing.T) {
		schema := Float64().Positive().Transform(func(val float64, ctx *RefinementContext) (any, error) {
...
func TestFloatRefine(t *testing.T) {
	...
	t.Run("refine vs transform distinction", func(t *testing.T) {
		...
		transformSchema := Float64().Transform(func(val float64, ctx *RefinementContext) (any, error) {
			return val * 2, nil
		})
...
func TestFloatErrorHandling(t *testing.T) {
	...
	t.Run("custom error messages", func(t *testing.T) {
		schema := Float64().Min(10.0, SchemaParams{
...
func TestFloatTypeSpecific(t *testing.T) {
	...
	t.Run("precision overflow protection", func(t *testing.T) {
		...
		schema := Float32(SchemaParams{Coerce: true})
