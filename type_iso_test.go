...
func TestISOTransform(t *testing.T) {
	t.Run("transform to time.Time", func(t *testing.T) {
		schema := ISO.Date().TransformAny(func(val any, ctx *RefinementContext) (any, error) {
	...
	t.Run("pipe to other schema", func(t *testing.T) {
		...
		schema := ISO.Date().Pipe(
			String().TransformAny(func(val any, ctx *RefinementContext) (any, error) {
				if dateStr, ok := val.(string); ok {
...
func TestISOErrorHandling(t *testing.T) {
	t.Run("custom error messages", func(t *testing.T) {
		...
		timeSchema := ISO.Time(ISOTimeOptions{Error: "Custom time validation error"})
		_, err = timeSchema.Parse("invalid-time")
		assert.Error(t, err)

		datetimeSchema := ISO.DateTime(ISODateTimeOptions{Error: "Custom datetime validation error"})
		_, err = datetimeSchema.Parse("invalid-datetime")
		assert.Error(t, err)

		durationSchema := ISO.Duration(ISODurationOptions{Error: "Custom duration validation error"})
	...
	t.Run("custom error for min validation", func(t *testing.T) {
		schema := ISO.Date().Min("1900-01-01", SchemaParams{
	...
	t.Run("custom error for max validation", func(t *testing.T) {
		...
		schema := ISO.Date().Max(today, SchemaParams{
...
func TestISOEdgeCases(t *testing.T) {
	...
	t.Run("non-string input types", func(t *testing.T) {
		...
		invalidInputs := []interface{}{
			...
			map[string]interface{}{"date": "2023-12-25"}, nil,
		}
...
func TestISODefaultAndPrefault(t *testing.T) {
	...
	t.Run("ISO in array schema", func(t *testing.T) {
		...
		validDates := []interface{}{"2023-01-01", "2023-12-31", "2024-02-29"}
	...
	t.Run("ISO with union", func(t *testing.T) {
		schema := Union([]ZodType[any, any]{ISO.Date(), ISO.Time()})
