...
func TestLazyBasicFunctionality(t *testing.T) {
	t.Run("basic lazy evaluation", func(t *testing.T) {
		schema := Lazy(func() core.ZodType[any, any] {
			return String().Min(3)
		})
...
func TestLazyCoercion(t *testing.T) {
	...
	t.Run("coercion with complex schema", func(t *testing.T) {
		schema := Lazy(func() core.ZodType[any, any] {
			return Object(core.ObjectSchema{
				"count": Int(),
			})
		})
...
func TestLazyModifiers(t *testing.T) {
	t.Run("optional wrapper", func(t *testing.T) {
		lazySchema := Lazy(func() core.ZodType[any, any] {
			return String().Email()
		})
...
func TestLazyChaining(t *testing.T) {
	...
	t.Run("chained methods", func(t *testing.T) {
		...
		refinedSchema := lazySchema.RefineAny(func(s any) bool {
			return len(s.(string)) > 2
		})
		schema := refinedSchema.TransformAny(func(s any, ctx *core.RefinementContext) (any, error) {
...
func TestLazyEdgeCases(t *testing.T) {
	t.Run("recursive schema evaluation", func(t *testing.T) {
		var TreeNodeSchema core.ZodType[any, any]
		TreeNodeSchema = Lazy(func() core.ZodType[any, any] {
			return Object(core.ObjectSchema{
				"value":    String(),
	...
	t.Run("mutual recursion", func(t *testing.T) {
		var personSchema, companySchema core.ZodType[any, any]

		personSchema = Lazy(func() core.ZodType[any, any] {
			return Object(core.ObjectSchema{
				"name":    String().Min(1),
		...
		companySchema = Lazy(func() core.ZodType[any, any] {
			return Object(core.ObjectSchema{
				"name":      String().Min(1),
	...
	t.Run("multiple lazy schemas independence", func(t *testing.T) {
		schema1 := Lazy(func() core.ZodType[any, any] {
			return String().Min(3)
		})

		schema2 := Lazy(func() core.ZodType[any, any] {
			return Int().Min(10)
		})
...
func TestLazyDefaultAndPrefault(t *testing.T) {
	...
	t.Run("default vs prefault distinction", func(t *testing.T) {
		...
		defaultSchema := Lazy(func() core.ZodType[any, any] {
			return String().Min(5)
		...
		counter := 0
		prefaultSchema := Lazy(func() core.ZodType[any, any] {
			return String().Min(5)
		}).(*ZodLazy).PrefaultFunc(func() any {
			counter++
			return fmt.Sprintf("lazy-prefault-%d", counter)
