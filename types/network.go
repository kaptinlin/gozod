...
func newIPv4[T StringConstraint](s *ZodString[T]) *ZodIPv4[T] {
	return &ZodIPv4[T]{s}
}
...
func newIPv6[T StringConstraint](s *ZodString[T]) *ZodIPv6[T] {
	return &ZodIPv6[T]{s}
}
...
func (z *ZodIPv6[T]) Optional() *ZodIPv6[*string] {
	return newIPv6(z.ZodString.Optional())
}

// Nilable returns a new schema that accepts nil values.
func (z *ZodIPv6[T]) Nilable() *ZodIPv6[*string] {
	return newIPv6(z.ZodString.Nilable())
}

// Nullish returns a new schema combining optional and nilable.
func (z *ZodIPv6[T]) Nullish() *ZodIPv6[*string] {
	return newIPv6(z.ZodString.Nullish())
}
...
func newCIDRv4[T StringConstraint](s *ZodString[T]) *ZodCIDRv4[T] {
	return &ZodCIDRv4[T]{s}
}
...
func (z *ZodCIDRv4[T]) Optional() *ZodCIDRv4[*string] {
	return newCIDRv4(z.ZodString.Optional())
}

// Nilable returns a new schema that accepts nil values.
func (z *ZodCIDRv4[T]) Nilable() *ZodCIDRv4[*string] {
	return newCIDRv4(z.ZodString.Nilable())
}

// Nullish returns a new schema combining optional and nilable.
func (z *ZodCIDRv4[T]) Nullish() *ZodCIDRv4[*string] {
	return newCIDRv4(z.ZodString.Nullish())
}
...
func newCIDRv6[T StringConstraint](s *ZodString[T]) *ZodCIDRv6[T] {
	return &ZodCIDRv6[T]{s}
}
...
func (z *ZodCIDRv6[T]) Optional() *ZodCIDRv6[*string] {
	return newCIDRv6(z.ZodString.Optional())
}

// Nilable returns a new schema that accepts nil values.
func (z *ZodCIDRv6[T]) Nilable() *ZodCIDRv6[*string] {
	return newCIDRv6(z.ZodString.Nilable())
}

// Nullish returns a new schema combining optional and nilable.
func (z *ZodCIDRv6[T]) Nullish() *ZodCIDRv6[*string] {
	return newCIDRv6(z.ZodString.Nullish())
}
...
func newURL[T StringConstraint](s *ZodString[T]) *ZodURL[T] {
	return &ZodURL[T]{s}
}
...
func (z *ZodURL[T]) Optional() *ZodURL[*string] {
	return newURL(z.ZodString.Optional())
}

// Nilable returns a new schema that accepts nil values.
func (z *ZodURL[T]) Nilable() *ZodURL[*string] {
	return newURL(z.ZodString.Nilable())
}

// Nullish returns a new schema combining optional and nilable.
func (z *ZodURL[T]) Nullish() *ZodURL[*string] {
	return newURL(z.ZodString.Nullish())
}
...
func newHostname[T StringConstraint](s *ZodString[T]) *ZodHostname[T] {
	return &ZodHostname[T]{s}
}
...
func (z *ZodHostname[T]) Optional() *ZodHostname[*string] {
	return newHostname(z.ZodString.Optional())
}

// Nilable returns a new schema that accepts nil values.
func (z *ZodHostname[T]) Nilable() *ZodHostname[*string] {
	return newHostname(z.ZodString.Nilable())
}

// Nullish returns a new schema combining optional and nilable.
func (z *ZodHostname[T]) Nullish() *ZodHostname[*string] {
	return newHostname(z.ZodString.Nullish())
}
...
func newMAC[T StringConstraint](s *ZodString[T]) *ZodMAC[T] {
	return &ZodMAC[T]{s}
}
...
func (z *ZodMAC[T]) Optional() *ZodMAC[*string] {
	return newMAC(z.ZodString.Optional())
}

// Nilable returns a new schema that accepts nil values.
func (z *ZodMAC[T]) Nilable() *ZodMAC[*string] {
	return newMAC(z.ZodString.Nilable())
}

// Nullish returns a new schema combining optional and nilable.
func (z *ZodMAC[T]) Nullish() *ZodMAC[*string] {
	return newMAC(z.ZodString.Nullish())
}
...
func newE164[T StringConstraint](s *ZodString[T]) *ZodE164[T] {
	return &ZodE164[T]{s}
}
...
func (z *ZodE164[T]) Optional() *ZodE164[*string] {
	return newE164(z.ZodString.Optional())
}

// Nilable returns a new schema that accepts nil values.
func (z *ZodE164[T]) Nilable() *ZodE164[*string] {
	return newE164(z.ZodString.Nilable())
}

// Nullish returns a new schema combining optional and nilable.
func (z *ZodE164[T]) Nullish() *ZodE164[*string] {
	return newE164(z.ZodString.Nullish())
}
