...
func TestEnumTransform(t *testing.T) {
	...
	t.Run("transform values", func(t *testing.T) {
		transformSchema := schema.TransformAny(func(val any, ctx *core.RefinementContext) (any, error) {
	...
	t.Run("transform with extract", func(t *testing.T) {
		...
		transformed := extracted.TransformAny(func(val any, ctx *core.RefinementContext) (any, error) {
			if str, ok := val.(string); ok {
