...
func TestTransformBasicFunctionality(t *testing.T) {
	t.Run("Transform constructor availability", func(t *testing.T) {
		...
		schema := Transform(func(input any, ctx *RefinementContext) (any, error) {
	...
	t.Run("string Transform method", func(t *testing.T) {
		baseSchema := String()
		transformSchema := baseSchema.Transform(func(s string, ctx *RefinementContext) (any, error) {
			return len(s), nil
		})
	...
	t.Run("transform flag verification", func(t *testing.T) {
		schema := String().Transform(func(s string, ctx *RefinementContext) (any, error) {
			return s, nil
		})
...
func TestTransformChaining(t *testing.T) {
	t.Run("simple chain transformation", func(t *testing.T) {
		...
		step1 := String().Transform(func(s string, ctx *RefinementContext) (any, error) {
			return strings.TrimSpace(s), nil
		})

		// Second transform: get length - use global Transform function
		step2 := step1.Pipe(Transform(func(input any, ctx *RefinementContext) (any, error) {
			if str, ok := input.(string); ok {
				return len(str), nil
			}
			return 0, nil
	...
	t.Run("complex type chain", func(t *testing.T) {
		...
		schema := step2.Pipe(Transform(func(input any, ctx *RefinementContext) (any, error) {
...
func TestTransformValidationIntegration(t *testing.T) {
	t.Run("validation before transform", func(t *testing.T) {
		...
		schema := String().Min(3).Transform(func(s string, ctx *RefinementContext) (any, error) {
			return strings.ToUpper(s), nil
		})
	...
	t.Run("transform with pipe validation", func(t *testing.T) {
		...
		baseTransform := String().Transform(func(s string, ctx *RefinementContext) (any, error) {
			return len(s), nil
		})

		// Create a validator for the transformed result
		resultValidator := Transform(func(input any, ctx *RefinementContext) (any, error) {
	...
	t.Run("transform with refine after", func(t *testing.T) {
		...
		schema := String().Transform(func(s string, ctx *RefinementContext) (any, error) {
			...
			return false
		}, SchemaParams{Error: "Transformed string cannot contain 'TEST'"})
...
func TestTransformWithDifferentTypes(t *testing.T) {
	...
	t.Run("TransformAny method", func(t *testing.T) {
		schema := String().TransformAny(func(input any, ctx *RefinementContext) (any, error) {
...
func TestTransformIntegration(t *testing.T) {
	t.Run("complex transformation pipeline", func(t *testing.T) {
		...
		step1 := String().Min(3).Transform(func(s string, ctx *RefinementContext) (any, error) {
			// Step 1: trim and lowercase
			cleaned := strings.ToLower(strings.TrimSpace(s))
			return cleaned, nil
		})

		schema := step1.Pipe(Transform(func(input any, ctx *RefinementContext) (any, error) {
	...
	t.Run("transform with pipe and refine", func(t *testing.T) {
		...
		validator := Transform(func(input any, ctx *RefinementContext) (any, error) {
			if str, ok := input.(string); ok {
	...
	t.Run("transform immutability", func(t *testing.T) {
		original := String().Transform(func(s string, ctx *RefinementContext) (any, error) {
			return len(s), nil
		})

		chained := original.Pipe(Transform(func(input any, ctx *RefinementContext) (any, error) {
			if length, ok := input.(int); ok {
				return length * 2, nil
			}
			return 0, nil
	...
	t.Run("transform with all modifier methods", func(t *testing.T) {
		...
		// Test with Pipe
		pipeSchema := baseTransform.Pipe(Transform(func(input any, ctx *RefinementContext) (any, error) {
			if length, ok := input.(int); ok {
				return length > 3, nil
			}
			return false, nil
