...
func (z *ZodDefault[T]) GetInternals() *ZodTypeInternals {
...
func (z *ZodDefault[T]) GetZod() *ZodTypeInternals {
...
func (z *ZodDefault[T]) Coerce(input any, ctx ...*ParseContext) (any, error) {
...
func (z *ZodDefault[T]) Parse(input any, ctx ...*ParseContext) (any, error) {
	if input == nil {
		...
		if internals != nil && internals.Type == "never" {
...
func (z *ZodDefault[T]) MustParse(input any, ctx ...*ParseContext) any {
...
func (z *ZodDefault[T]) Check(fn CheckFn) ZodType[any, any] {
...
func (z *ZodDefault[T]) Transform(fn func(any, *RefinementContext) (any, error)) ZodType[any, any] {
...
func (z *ZodDefault[T]) TransformAny(fn func(any, *RefinementContext) (any, error)) ZodType[any, any] {
...
func (z *ZodDefault[T]) Optional() ZodType[any, any] {
	// Apply to inner type
...
func (z *ZodDefault[T]) Nilable() ZodType[any, any] {
...
func (z *ZodDefault[T]) Nullish() ZodType[any, any] {
	return z.Nilable()
}

// Refine adds a flexible validation function to the default schema, returns ZodDefault support chain call
func (z *ZodDefault[T]) Refine(fn func(string) bool, params ...SchemaParams) *ZodDefault[T] {
...
func (z *ZodDefault[T]) RefineAny(fn func(any) bool, params ...SchemaParams) ZodType[any, any] {
...
func (z *ZodDefault[T]) Unwrap() ZodType[any, any] {
...
func (z *ZodDefault[T]) Pipe(out ZodType[any, any]) ZodType[any, any] {
	return &ZodPipe[any, any]{
		in:  any(z).(ZodType[any, any]), // Use the Default wrapper
		out: out,
...
func (z *ZodDefault[T]) Prefault(value any) ZodType[any, any] {
...
func (z *ZodDefault[T]) PrefaultFunc(fn func() any) ZodType[any, any] {
