...
func TestBoolBasicFunctionality(t *testing.T) {
	...
	t.Run("custom error", func(t *testing.T) {
		customError := "Custom boolean validation error"
		schema := Bool(SchemaParams{Error: customError})
		require.NotNil(t, schema)
		assert.Equal(t, "bool", schema.internals.Def.Type)
	})

	t.Run("coerce flag", func(t *testing.T) {
		schema := Bool(SchemaParams{Coerce: true})
		require.NotNil(t, schema)
...
func TestBoolTransform(t *testing.T) {
	t.Run("transform method", func(t *testing.T) {
		schema := Bool().Transform(func(val bool, ctx *RefinementContext) (any, error) {
			if val {
				return "TRUE", nil
			}
			return "FALSE", nil
	...
	t.Run("transform chaining", func(t *testing.T) {
		schema := Bool().
			Transform(func(val bool, ctx *RefinementContext) (any, error) {
				return val, nil
			}).
...
func TestBoolEdgeCases(t *testing.T) {
	...
	t.Run("complex type rejection", func(t *testing.T) {
		...
		complexTypes := []interface{}{
			...
			[]interface{}{true},
			map[interface{}]interface{}{"key": true},
		}
