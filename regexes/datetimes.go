...
// ValidateDuration validates that a duration string has at least one numeric component
// This addresses the limitation of Go's regexp not supporting lookaheads
func ValidateDuration(duration string) bool {
	// First check basic format
	if !Duration.MatchString(duration) {
		return false
	}
